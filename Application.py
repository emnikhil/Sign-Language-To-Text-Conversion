...
class Application:
    ...
    def action_call(self) :
        ...
        self.tx.config(text = "Project By", fg = "red", font = ("Courier", 30, "bold"))

        self.photo1 = tk.PhotoImage(file = 'Pictures/nikhil.png')
        ...
        self.tx6.config(text = "Nikhil Gupta\n 17EBKCS067", font = ("Courier", 15, "bold"))

        self.photo2 = tk.PhotoImage(file = 'Pictures/priyansh.png')
        ...
        self.tx2.config(text = "Priyansh Lakhotia\n 17EBKCS077", font = ("Courier", 15, "bold"))
        ...
        self.photo3 = tk.PhotoImage(file='Pictures/vikas.png')
        self.w3 = tk.Label(self.root1, image = self.photo6)
        self.w3.place(x = 350, y = 420)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 230, y = 670)
        self.tx6.config(text = "Mr. Vikas Kumawat", font = ("Courier", 30, "bold"))
